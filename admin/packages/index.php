...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Add New Package","packages/manage_package.php",'mid-large')
		})
        $('.edit_data').click(function(){
			uni_modal("Update Package Details","packages/manage_package.php?id="+$(this).attr('data-id'),'mid-large')
		})
